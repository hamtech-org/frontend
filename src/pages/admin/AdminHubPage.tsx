...
import { BarChart3, Bot, FileText, HardDrive, Users, UsersRound } from 'lucide-react';
...
const modules = [
  ...
  {
    to: '/admin/ai',
    title: 'Quản lý và Cấu Hình AI',
    description: 'Theo dõi sử dụng AI, provider, model, token và cấu hình RAG/Qdrant.',
    icon: Bot,
