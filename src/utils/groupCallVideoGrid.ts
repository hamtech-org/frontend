/** Khoảng cách giữa các ô video nhóm (px). */
export const GROUP_TILE_GAP_PX = 8;

/** Kích thước tối thiểu mỗi ô (gần tile filmstrip ~140×~80, hơi lớn hơn một chút). */
export const GROUP_TILE_MIN_W = 168;
export const GROUP_TILE_MIN_H = 96;

/**
 * Số remote tối đa hiển thị trên một trang sao cho tồn tại bố cục cols×rows
 * với mỗi ô >= minW × minH.
 */
...
/** Số cột / hàng cho n ô (lưới gần vuông). */
