...
export function WidgetAdminQuick({
  ...
  return (
    <Card className="rounded-2xl border border-amber-500/30 bg-amber-500/5 dark:bg-amber-500/10 backdrop-blur-xl p-4 shadow-[0_8px_30px_rgba(245,158,11,0.03)] transition-all duration-300 hover:border-amber-500/40">
