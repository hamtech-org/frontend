...
interface ReelPlayerFullHandle {
  togglePlayback: () => void;
}
...
export type { ReelPlayerFullHandle, VideoRect };

export const ReelPlayerFull = forwardRef<ReelPlayerFullHandle, Props>(
  ({ reel, isVisible, volume, onVolumeChange, isMuted, onMutedChange, onVideoRectChange }, ref) => {
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              width: showVolumeSlider ? '11rem' : '3rem',
...
ReelPlayerFull.displayName = 'ReelPlayerFull';
